...
object SettingsSearch {
    ...
    private val EXTRA_TERMS: Map<SettingsCategory, List<Int>> = mapOf(
        ...
        SettingsCategory.Reading to listOf(
            ...
            R.string.settings_reader_margin,
            R.string.settings_reader_margin_compact,
            R.string.settings_reader_margin_default,
            R.string.settings_reader_margin_comfortable,
