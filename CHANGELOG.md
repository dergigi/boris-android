...
- Tapping a `read.withboris.com` link opens Boris instead of the browser (#218)
...
- Settings About can recommend Boris on Nostr (kind 31989)
...
- Long-press link menu can open in the reader or the in-app browser

### Fixed

- Idle reaction heart uses the same blue as Archive, so it no longer looks already liked
...
- Highlighting text no longer opens Amber twice, which had blocked the highlight from being created
...
- Shared signing, reader, and social-graph code so later highlight work has one place to land
...
- Long articles scroll without recomposing the whole page on every frame
- TTS sentence ticks only redraw the paragraph being spoken
- Saving reading progress no longer recomposes the article
...
- Display type in Appearance: Color or E-ink
- Reset to defaults on each settings section

## [1.5.22] - 2026-08-30

### Fixed

- Listening progress is saved while TTS plays with the screen locked
...
- Time window picker on Most highlighted: last 24 hours, 7 days, or 30 days
- Share icon on highlight cards, including Share article for regular web articles

### Changed

- Hide article and hide user live behind the crossed-out eye next to the quote mark

### Fixed

- Short highlights paint only the selected occurrence, not every matching word
...
- Contents pane uses square edges like a side pane
...
- Search field on Home that opens the Search tab
- Compact refresh spinner in the top bars of Home, Feeds, Library, You, and profiles
- Tap the Random Unreads heading to reshuffle that row without a full Home refresh

### Changed

- NSFW labels are compact `NSFW` / `NSFW?` pills next to reading time
...
- Reader distinguishes the saved reading position from exploratory scrolling: fast jumps no longer overwrite your position, a "Back to X%" pill returns to it, and the progress bar marks the current scroll with a dot while drifted
...
- Direct image links open in the image viewer
- Home clipboard banner opens notes, highlights, and comments

## [1.5.3] - 2026-08-22

### Added

- Copy njump link from Nostr-native article menus
- Copy xcancel link from x.com and twitter.com article menus
- Website FAQ in Settings/About

## [1.5.2] - 2026-08-22

### Added

- Reset reading progress from the reader overflow menu and article long-press menus

### Fixed

- Text selection magnifier sits above the thumb instead of under it
- Filter chips stay on one row and scroll sideways on narrow screens
...
- Parsed web articles stay cached so reopening a page is instant
- Refresh article in the reader menu re-fetches and re-parses the page
...
- TTS follow-along stays on the spoken paragraph when the same words appear elsewhere
- Reader follows HTML forwarding pages such as short `dergigi.com` links
...
- TTS skips bare URLs and images, and still speaks markdown link labels

## [1.4.35] - 2026-08-20

### Fixed

- Reader scrolling no longer stutters from contents outline tracking
- Contents heading taps scroll to the matching heading
- Highlights pane stays below the reader top bar
...
- Reader scrolling stays smooth while TTS follow-along is painting the spoken sentence
...
- Reader no longer hitches when reversing scroll direction

## [1.4.23] - 2026-08-20

### Fixed

- Reader drops share bars, follow widgets, and image-credit captions above the article
...
- Reader scrolling no longer recomposes the whole article on every frame

## [1.4.20] - 2026-08-20

### Fixed

- Pretty-printed article HTML no longer renders as clipped code blocks
...
- Articles turn nostr:nevent and nostr:note into title links or cards
...
- Adjacent Markdown images no longer overlap article text

## [1.4.14] - 2026-08-19

### Fixed

- Light-mode highlight cards keep yellow borders and icons visible against cream paper
...
[1.5.22]: https://github.com/dergigi/boris-android/releases/tag/v1.5.22
[1.5.21]: https://github.com/dergigi/boris-android/releases/tag/v1.5.21
[1.5.20]: https://github.com/dergigi/boris-android/releases/tag/v1.5.20
[1.5.19]: https://github.com/dergigi/boris-android/releases/tag/v1.5.19
[1.5.18]: https://github.com/dergigi/boris-android/releases/tag/v1.5.18
...
[1.5.5]: https://github.com/dergigi/boris-android/releases/tag/v1.5.5
[1.5.4]: https://github.com/dergigi/boris-android/releases/tag/v1.5.4
[1.5.3]: https://github.com/dergigi/boris-android/releases/tag/v1.5.3
[1.5.2]: https://github.com/dergigi/boris-android/releases/tag/v1.5.2
...
[1.4.40]: https://github.com/dergigi/boris-android/releases/tag/v1.4.40
...
[1.4.35]: https://github.com/dergigi/boris-android/releases/tag/v1.4.35
...
[1.4.12]: https://github.com/dergigi/boris-android/releases/tag/v1.4.12
[1.4.11]: https://github.com/dergigi/boris-android/releases/tag/v1.4.11
