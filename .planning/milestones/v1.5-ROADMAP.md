...
Optional Amber and bunker identity, NIP-84 highlights, on-device TTS, nprofile links, and on-device article extraction. Reading stays ungated. Shipped as 1.4.x patches, then cut as 1.5.0.

# Roadmap: Boris (archived)
